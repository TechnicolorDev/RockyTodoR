...
class EmailController {
    static async sendForgotPasswordEmail(req, res) {
        try {
            ...
            console.log("Generated ResetPassword CSRF Token:", csrfToken);

            await csrfStore.saveToken(`${process.env.APP_NAME}-password-csrfToken`, csrfToken, 3600);
            ...
            res.status(202).json({ message: "Password reset email is being processed."});
    ...
    static async resetPassword(req, res) {
        try {
            ...
            const csrfTokenGenerated = await csrfStore.getStoredToken(`${process.env.APP_NAME}-password-csrfToken`);
